...
function(set_target_properties_obs target)
  ...
  elseif(target_type STREQUAL MODULE_LIBRARY)
    ...
    install(
      ...
      LIBRARY
        DESTINATION
          "$<IF:$<OR:$<STREQUAL:${target},obspython>,$<STREQUAL:${target},obslua>>,${OBS_SCRIPT_PLUGIN_DESTINATION},${OBS_PLUGIN_DESTINATION}>"
        COMPONENT Runtime
    ...
    add_custom_command(
      ...
      COMMAND
        ...
        "${OBS_OUTPUT_DIR}/$<CONFIG>/$<IF:$<OR:$<STREQUAL:${target},obspython>,$<STREQUAL:${target},obslua>>,${OBS_SCRIPT_PLUGIN_DESTINATION},${OBS_PLUGIN_DESTINATION}>"
      COMMAND
        "${CMAKE_COMMAND}" -E copy_if_different "$<TARGET_FILE:${target}>"
        "${OBS_OUTPUT_DIR}/$<CONFIG>/$<IF:$<OR:$<STREQUAL:${target},obspython>,$<STREQUAL:${target},obslua>>,${OBS_SCRIPT_PLUGIN_DESTINATION},${OBS_PLUGIN_DESTINATION}>"
      COMMENT
        "Copy ${target} to plugin directory ($<IF:$<BOOL:${_scripting_plugin}>,${OBS_SCRIPT_PLUGIN_DESTINATION},${OBS_PLUGIN_DESTINATION}>)"
      VERBATIM)
      ...
      if(TARGET CEF::Library)
        ...
        if(imported_location)
          ...
          add_custom_command(
            ...
            COMMAND
              "${CMAKE_COMMAND}" -E copy_if_different "${imported_location}" "${cef_location}/libEGL.so"
              "${cef_location}/libGLESv2.so" "${cef_location}/libvk_swiftshader.so" "${cef_location}/libvulkan.so.1"
              "${cef_location}/snapshot_blob.bin" "${cef_location}/v8_context_snapshot.bin"
