...
if(NOT DEFINED OBS_PARENT_ARCHITECTURE)
  if(CMAKE_GENERATOR_PLATFORM MATCHES "(Win32|x64|ARM64)")
...
if(OBS_PARENT_ARCHITECTURE STREQUAL CMAKE_GENERATOR_PLATFORM)
  if(OBS_PARENT_ARCHITECTURE STREQUAL ARM64)
    execute_process(
      COMMAND
        "${CMAKE_COMMAND}" -S ${CMAKE_CURRENT_SOURCE_DIR} -B ${CMAKE_SOURCE_DIR}/build_x64 -A x64 -G
        ...
        -DENABLE_CCACHE:BOOL=${ENABLE_CCACHE} -DOBS_PARENT_ARCHITECTURE:STRING=ARM64
