...
elseif(CMAKE_HOST_SYSTEM_NAME MATCHES "Linux|FreeBSD")
  set(LibAJANTV2_ERROR_REASON
      "Ensure ajantv2 static libraries are available in local library paths.")
endif()
...
if(LibAJANTV2_FOUND)
  ...
  if(NOT TARGET AJA::LibAJANTV2)
    if(IS_ABSOLUTE "${LibAJANTV2_LIBRARY_RELEASE}")
      ...
      set_property(TARGET AJA::LibAJANTV2 PROPERTY IMPORTED_LOCATION
                                                   "${LibAJANTV2_LIBRARY_RELEASE}")
    else()
    ...
    if(LibAJANTV2_LIBRARY_DEBUG)
      if(IS_ABSOLUTE "${LibAJANTV2_LIBRARY_DEBUG}")
        set_property(TARGET AJA::LibAJANTV2 PROPERTY IMPORTED_LOCATION_DEBUG
                                                     "${LibAJANTV2_LIBRARY_DEBUG}")
      else()
        set_property(TARGET AJA::LibAJANTV2 PROPERTY IMPORTED_LIBNAME_DEBUG
                                                     "${LibAJANTV2_LIBRARY_DEBUG}")
      endif()
      set_property(
