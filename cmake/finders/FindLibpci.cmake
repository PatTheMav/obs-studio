...
elseif(EXISTS "${Libpci_INCLUDE_DIR}/config.h")
  file(STRINGS "${Libpci_INCLUDE_DIR}/config.h" _VERSION_STRING
       REGEX "^.*PCILIB_VERSION[ \t]+[0-9]+[ \t]*$")
...
find_package_handle_standard_args(
  ...
  VERSION_VAR Libpci_VERSION REASON_FAILURE_MESSAGE
                             "Ensure that libpci is installed on the system.")
