...
elseif(EXISTS "${Libsrt_INCLUDE_DIR}/version.h")
  file(STRINGS "${Libsrt_INCLUDE_DIR}/version.h" _VERSION_STRING
       REGEX "#define[ \t]+SRT_VERSION_STRING[ \t]+.+")
  string(REGEX REPLACE ".*#define[ \t]+SRT_VERSION_STRING[ \t]+\"(.+)\".*" "\\1" Libsrt_VERSION
                       "${_VERSION_STRING}")
else()
...
if(Libsrt_FOUND)
  if(NOT TARGET Libsrt::Libsrt)
    ...
    set_target_properties(
      Libsrt::Libsrt PROPERTIES INTERFACE_COMPILE_OPTIONS "${PC_Libsrt_CFLAGS_OTHER}"
