...
# _check_dependencies_macos: Setup macOS slice for _check_dependencies
function(_check_dependencies_macos)
  ...
  # cmake-format: off
  string(JSON deployment_target GET ${buildspec} platformConfig ${platform} deploymentTarget)
  # cmake-format: on
