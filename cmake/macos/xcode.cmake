...
if(ENABLE_CCACHE AND CCACHE_PROGRAM)
  ...
  configure_file("${CMAKE_SOURCE_DIR}/cmake/macos/resources/ccache-launcher-cxx.in"
                 ccache-launcher-cxx)

  execute_process(COMMAND chmod a+rx "${CMAKE_BINARY_DIR}/ccache-launcher-c"
                          "${CMAKE_BINARY_DIR}/ccache-launcher-cxx")
  ...
  set(CMAKE_XCODE_ATTRIBUTE_LD "${CMAKE_BINARY_DIR}/ccache-launcher-c")
  set(CMAKE_XCODE_ATTRIBUTE_LDPLUSPLUS "${CMAKE_BINARY_DIR}/ccache-launcher-cxx")
endif()

# Set project variables
set(CMAKE_XCODE_ATTRIBUTE_CURRENT_PROJECT_VERSION ${OBS_BUILD_NUMBER})
# set(CMAKE_XCODE_ATTRIBUTE_CURRENT_VERSION "${OBS_VERSION_CANONICAL}")
...
# Enable codesigning with hardened runtime option not in Debug configuration (required for
# Notarization)
...
# set(CMAKE_XCODE_ATTRIBUTE_GCC_C_LANGUAGE_STANDARD c99) Set C++ language default to c++17
