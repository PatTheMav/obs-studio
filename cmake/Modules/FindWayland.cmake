	...
	if(NOT TARGET Wayland::${component})
		...
		if(Wayland_${component}_FOUND)
			if(IS_ABSOLUTE "${WAYLAND_${component_u}_LIBRARIES}")
				...
				set_target_properties(Wayland::${component} PROPERTIES IMPORTED_LOCATION
					"${WAYLAND_${component_u}_LIBRARIES}")
			else()
				add_library(Wayland::${component} INTERFACE IMPORTED)
				set_target_properties(Wayland::${component} PROPERTIES IMPORTED_LIBNAME
					"${WAYLAND_${component_u}_LIBRARIES}")
			endif()
