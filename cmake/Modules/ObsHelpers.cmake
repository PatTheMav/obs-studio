...
function(setup_script_plugin_target target)
	...
	if(${target} STREQUAL "obspython")
		install(FILES "$<TARGET_FILE_DIR:${target}>/$<TARGET_FILE_BASE_NAME:${target}>.py"
...
function(setup_target_browser target)
	install(DIRECTORY
		"${CEF_ROOT_DIR}/Resources/" DESTINATION "${OBS_PLUGIN_DESTINATION}")

	install(DIRECTORY
		"${CEF_ROOT_DIR}/Release/" DESTINATION "${OBS_PLUGIN_DESTINATION}")
...
macro(set_option option value)
	set(${option} ${value} CACHE INTERNAL "")
endmacro()
