...
function(setup_target_pdbs target destination)
  ...
  copy_target_pdb(${target} "${CMAKE_CURRENT_BINARY_DIR}/pdbs" "${_INSTALL_LOCATION}")
...
function(copy_target_pdb target destination rundir_location)
  ...
  add_custom_command(
    ...
    COMMAND
      "${CMAKE_COMMAND}" -E
      "$<IF:$<OR:$<CONFIG:Debug>,$<CONFIG:RelWithDebInfo>>,copy,true>"
      "$<TARGET_PDB_FILE:${target}>" "${CMAKE_BINARY_DIR}/rundir/$<CONFIG>/${rundir_location}"
    VERBATIM)
endfunction()
