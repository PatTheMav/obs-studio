set(OBS_COMPANY_NAME "Wizards of OBS, LLC")
...
# Set release candidate version information
...
if(NOT DEFINED OBS_VERSION_OVERRIDE)
	...
	set(_OBS_VERSION_CANONICAL ${_OBS_VERSION})
endif()
...
if(NOT DEFINED BUILD_NUMBER_CACHE)
	set(BUILD_NUMBER_CACHE ${CMAKE_SOURCE_DIR}/cmake/CMakeBuildNumber.cmake CACHE STRING "OBS build number cache file" FORCE)
	mark_as_advanced(BUILD_NUMBER_CACHE)
endif()
