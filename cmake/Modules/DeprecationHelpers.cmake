function(install_obs_plugin_with_data)
	message(DEPRECATION "OBS: The install_obs_plugin_with_data command is deprecated and will be removed soon - use 'setup_plugin_target' instead.")
	_install_obs_plugin_with_data(${ARGV})
endfunction()

function(install_obs_plugin)
	message(DEPRECATION "OBS: The install_obs_plugin command is deprecated and will be removed soon - use 'setup_plugintarget' instead.")
	_install_obs_plugin(${ARGV})
endfunction()

function(install_obs_datatarget)
	message(DEPRECATION "OBS: The install_obs_datatarget function is deprecated and will be removed soon - use 'setup_target_resources' instead.")
...
function(__deprecated_feature var access)
	if(access STREQUAL "UNKNOWN_READ_ACCESS")
		message(DEPRECATION "OBS: The feature enabled by '${var}' is deprecated and will soon be removed from OBS.")
	endif()
endfunction()
