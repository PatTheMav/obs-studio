...
mark_as_advanced(
	CEF_LIBRARY CEF_WRAPPER_LIBRARY CEF_LIBRARIES CEF_INCLUDE_DIR)
...
if(NOT TARGET CEF::Wrapper)
	if(IS_ABSOLUTE "${CEF_LIBRARIES}")
		...
		if(DEFINED CEFWRAPPER_LIBRARY_DEBUG)
			...
			set_target_properties(CEF::Wrapper_Debug PROPERTIES IMPORTED_LOCATION
		...
		if(DEFINED CEFWRAPPER_LIBRARY_DEBUG)
			...
			set_target_properties(CEF::Wrapper_Debug PROPERTIES IMPORTED_LIBNAME
				${CEFWRAPPER_LIBRARY_DEBUG})
		endif()
	endif()
	...
	if(DEFINED CEFWRAPPER_LIBRARY_DEBUG)
		set_target_properties(CEF::Wrapper_Debug PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
			"${CEF_INCLUDE_DIR}")
	endif()
endif()
