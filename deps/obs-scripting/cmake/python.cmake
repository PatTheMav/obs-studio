...
if(ENABLE_SCRIPTING_PYTHON)
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E env "SWIG_LIB=${SWIG_DIR}" ${SWIG_EXECUTABLE} -python
            $<IF:$<PLATFORM_ID:Windows,Darwin>,-py3-stable-abi,-py3> -external-runtime swig/swigpyrun.h
  ...
  target_link_libraries(obs-scripting PRIVATE $<$<NOT:$<PLATFORM_ID:Windows,Darwin>>:Python::Python>)
