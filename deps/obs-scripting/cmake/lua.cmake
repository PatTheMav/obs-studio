...
target_sources(obs-scripting PRIVATE obs-scripting-lua.c obs-scripting-lua.h
...
add_custom_command(
  ...
  COMMAND ${CMAKE_COMMAND} -E env "SWIG_LIB=${SWIG_DIR}" ${SWIG_EXECUTABLE} -lua
          -external-runtime swig/swigluarun.h
...
set_source_files_properties(
  ...
  PROPERTIES
    COMPILE_OPTIONS
    "$<$<C_COMPILER_ID:AppleClang,Clang>:-Wno-error=shorten-64-to-32;-Wno-error=shadow>"
)
