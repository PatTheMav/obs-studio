...
public func device_get_texture_type(texture: UnsafeRawPointer) -> gs_texture_type {
    ...
    return texture.type.toGSTextureType()
}
...
public func device_texture_get_width(tex: UnsafeRawPointer) -> UInt32 {
    ...
    switch texture.type {
    case .type2D: return UInt32(texture.texture.width)
    default: return 0
    }
}
...
public func device_texture_get_height(tex: UnsafeRawPointer) -> UInt32 {
    ...
    switch texture.type {
    case .type2D: return UInt32(texture.texture.height)
    default: return 0
    }
}
...
public func gs_texture_get_color_format(tex: UnsafeRawPointer) -> gs_color_format {
    ...
    switch texture.type {
    case .type2D: return texture.texture.pixelFormat.toGSColorFormat()
...
public func gs_texture_map(
    ...
    guard texture.type == .type2D else {
        return false
    }
