...
class MetalDevice {
    ...
    func blitSwapChains() {
        guard let swapChains = swapChains else { return }
        ...
        autoreleasepool {
            for swapChain in swapChains {
                ...
                swapChain.inFlightDrawable = drawable
    ...
    ///
    func stageBuffer(source: MetalTexture, destination: MetalStageBuffer) throws {
        if source.hasPendingWrites {
            finishPendingCommands()
        }
