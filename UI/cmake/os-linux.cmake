...
target_compile_definitions(obs-studio
                           PRIVATE OBS_INSTALL_PREFIX="${CMAKE_INSTALL_PREFIX}")
...
if(NOT DEFINED APPDATA_RELEASE_DATE)
  ...
  elseif(EXISTS "${CMAKE_SOURCE_DIR}/cmake/.CMakeBuildNumber")
    file(TIMESTAMP "${CMAKE_SOURCE_DIR}/cmake/.CMakeBuildNumber"
         APPDATA_RELEASE_DATE "%Y-%m-%d")
  else()
...
configure_file(cmake/linux/com.obsproject.Studio.appdata.xml.in
               com.obsproject.Studio.appdata.xml)

install(FILES "${CMAKE_CURRENT_BINARY_DIR}/com.obsproject.Studio.appdata.xml"
        DESTINATION "${CMAKE_INSTALL_DATAROOTDIR}/metainfo")

install(FILES cmake/linux/com.obsproject.Studio.desktop
