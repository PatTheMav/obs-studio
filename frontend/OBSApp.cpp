...
#include <components/OBSEventFilter.hpp>
...
static constexpr std::string_view OBSGlobalIniPath = "/obs-studio/global.ini";
static constexpr std::string_view OBSUserIniPath = "/obs-studio/user.ini";
static constexpr std::string_view OBSProfileSubDirectory = "obs-studio/basic/profiles";
static constexpr std::string_view OBSScenesSubDirectory = "obs-studio/basic/scenes";
