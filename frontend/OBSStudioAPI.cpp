...
void *OBSStudioAPI::obs_frontend_get_system_tray(void)
{
...
obs_source_t *OBSStudioAPI::obs_frontend_get_current_scene(void)
{
...
obs_source_t *OBSStudioAPI::obs_frontend_get_current_transition(void)
{
...
int OBSStudioAPI::obs_frontend_get_transition_duration(void)
{
...
void OBSStudioAPI::obs_frontend_release_tbar(void)
{
...
int OBSStudioAPI::obs_frontend_get_tbar_position(void)
{
...
char *OBSStudioAPI::obs_frontend_get_current_scene_collection(void)
{
...
bool OBSStudioAPI::obs_frontend_add_scene_collection(const char *name)
{
	...
	QMetaObject::invokeMethod(main, "CreateNewSceneCollection", WaitConnection(), Q_RETURN_ARG(bool, success),
				  Q_ARG(bool, true), Q_ARG(QString, QT_UTF8(name)));
	return success;
}
...
char *OBSStudioAPI::obs_frontend_get_current_profile(void)
{
	const OBSProfile &profile = main->GetCurrentProfile();
	return bstrdup(profile.name.c_str());
}

char *OBSStudioAPI::obs_frontend_get_current_profile_path(void)
{
	const OBSProfile &profile = main->GetCurrentProfile();
...
void OBSStudioAPI::obs_frontend_streaming_start(void)
{
	QMetaObject::invokeMethod(main, "StartStreaming");
}

void OBSStudioAPI::obs_frontend_streaming_stop(void)
{
	QMetaObject::invokeMethod(main, "StopStreaming");
}

bool OBSStudioAPI::obs_frontend_streaming_active(void)
{
	return os_atomic_load_bool(&streaming_active);
}

void OBSStudioAPI::obs_frontend_recording_start(void)
{
	QMetaObject::invokeMethod(main, "StartRecording");
}

void OBSStudioAPI::obs_frontend_recording_stop(void)
{
	QMetaObject::invokeMethod(main, "StopRecording");
}

bool OBSStudioAPI::obs_frontend_recording_active(void)
{
...
bool OBSStudioAPI::obs_frontend_recording_paused(void)
{
	return os_atomic_load_bool(&recording_paused);
}

bool OBSStudioAPI::obs_frontend_recording_split_file(void)
{
...
void OBSStudioAPI::obs_frontend_replay_buffer_start(void)
{
	QMetaObject::invokeMethod(main, "StartReplayBuffer");
}

void OBSStudioAPI::obs_frontend_replay_buffer_save(void)
{
	QMetaObject::invokeMethod(main, "ReplayBufferSave");
}

void OBSStudioAPI::obs_frontend_replay_buffer_stop(void)
{
	QMetaObject::invokeMethod(main, "StopReplayBuffer");
}

bool OBSStudioAPI::obs_frontend_replay_buffer_active(void)
{
...
obs_output_t *OBSStudioAPI::obs_frontend_get_streaming_output(void)
{
...
obs_output_t *OBSStudioAPI::obs_frontend_get_recording_output(void)
{
	OBSOutput out = main->outputHandler->fileOutput.Get();
	return obs_output_get_ref(out);
}

obs_output_t *OBSStudioAPI::obs_frontend_get_replay_buffer_output(void)
{
	OBSOutput out = main->outputHandler->replayBuffer.Get();
	return obs_output_get_ref(out);
}

config_t *OBSStudioAPI::obs_frontend_get_profile_config(void)
{
	return main->activeConfiguration;
}

config_t *OBSStudioAPI::obs_frontend_get_global_config(void)
{
	blog(LOG_WARNING,
...
config_t *OBSStudioAPI::obs_frontend_get_app_config(void)
{
	return App()->GetAppConfig();
}

config_t *OBSStudioAPI::obs_frontend_get_user_config(void)
{
...
void OBSStudioAPI::obs_frontend_save(void)
{
	main->SaveProject();
}

void OBSStudioAPI::obs_frontend_defer_save_begin(void)
{
	QMetaObject::invokeMethod(main, "DeferSaveBegin");
}

void OBSStudioAPI::obs_frontend_defer_save_end(void)
{
...
void OBSStudioAPI::obs_frontend_pop_ui_translation(void)
{
...
obs_service_t *OBSStudioAPI::obs_frontend_get_streaming_service(void)
{
	return main->GetService();
}

void OBSStudioAPI::obs_frontend_save_streaming_service(void)
{
	main->SaveService();
}

bool OBSStudioAPI::obs_frontend_preview_program_mode_active(void)
{
...
void OBSStudioAPI::obs_frontend_preview_program_trigger_transition(void)
{
	QMetaObject::invokeMethod(main, "TransitionClicked");
}

bool OBSStudioAPI::obs_frontend_preview_enabled(void)
{
...
obs_source_t *OBSStudioAPI::obs_frontend_get_current_preview_scene(void)
{
	if (main->IsPreviewProgramMode()) {
		OBSSource source = main->GetCurrentSceneSource();
		return obs_source_get_ref(source);
...
void OBSStudioAPI::obs_frontend_take_screenshot(void)
{
...
obs_output_t *OBSStudioAPI::obs_frontend_get_virtualcam_output(void)
{
	OBSOutput output = main->outputHandler->virtualCam.Get();
	return obs_output_get_ref(output);
}

void OBSStudioAPI::obs_frontend_start_virtualcam(void)
{
	QMetaObject::invokeMethod(main, "StartVirtualCam");
}

void OBSStudioAPI::obs_frontend_stop_virtualcam(void)
{
	QMetaObject::invokeMethod(main, "StopVirtualCam");
}

bool OBSStudioAPI::obs_frontend_virtualcam_active(void)
{
	return os_atomic_load_bool(&virtualcam_active);
}

void OBSStudioAPI::obs_frontend_reset_video(void)
{
	main->ResetVideo();
}
...
char *OBSStudioAPI::obs_frontend_get_current_record_output_path(void)
{
...
bool OBSStudioAPI::obs_frontend_is_theme_dark(void)
{
	return App()->IsThemeDark();
}

char *OBSStudioAPI::obs_frontend_get_last_recording(void)
{
	return bstrdup(main->outputHandler->lastRecordingPath.c_str());
}

char *OBSStudioAPI::obs_frontend_get_last_screenshot(void)
{
	return bstrdup(main->lastScreenshot.c_str());
}

char *OBSStudioAPI::obs_frontend_get_last_replay(void)
{
