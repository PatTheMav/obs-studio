...
target_compile_features(ftl-sdk INTERFACE c_std_11)
...
if(OS_WINDOWS)
  target_sources(
    ftl-sdk
    INTERFACE ftl-sdk/libftl/gettimeofday/gettimeofday.c ftl-sdk/libftl/gettimeofday/gettimeofday.h
              ftl-sdk/libftl/win32/socket.c ftl-sdk/libftl/win32/threads.c
...
if(CMAKE_C_COMPILER_ID STREQUAL AppleClang OR CMAKE_C_COMPILER_ID STREQUAL Clang)
  list(APPEND silence_ftl -Wno-error=incompatible-function-pointer-types
       -Wno-error=implicit-int-conversion -Wno-error=shorten-64-to-32 -Wno-error=macro-redefined)
elseif(CMAKE_C_COMPILER_ID STREQUAL GNU)
  list(APPEND silence_ftl -Wno-error=extra -Wno-error=incompatible-pointer-types
       -Wno-error=int-conversion -Wno-error=builtin-macro-redefined)
endif()
