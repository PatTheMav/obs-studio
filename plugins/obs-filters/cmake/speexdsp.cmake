...
if(ENABLE_SPEEXDSP)
  ...
  target_link_options(obs-filters PRIVATE $<$<PLATFORM_ID:Windows>:/LTCG>
                      $<$<PLATFORM_ID:Windows>:/IGNORE:4098> $<$<PLATFORM_ID:Windows>:/IGNORE:4099>)

  target_enable_feature(obs-filters "SpeexDSP noise supression" HAS_NOISEREDUCTION)
else()
  target_disable_feature(obs-filters "SpeexDSP noise supression")
endif()
