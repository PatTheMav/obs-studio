...
if(NOT ENABLE_SPEEXDSP)
  ...
  if(OS_WINDOWS)
    target_link_options(obs-filters PRIVATE "LINKER:/LTCG" "LINKER:/IGNORE:4098"
                        "LINKER:/IGNORE:4099")
  endif()
endif()
...
if(NOT ENABLE_RNNOISE)
  ...
  if(NOT TARGET Librnnoise::Librnnoise)
    ...
    target_compile_options(
      obs-rnnoise INTERFACE "$<$<COMPILE_LANG_AND_ID:C,AppleClang,Clang>:-Wno-null-dereference>")
